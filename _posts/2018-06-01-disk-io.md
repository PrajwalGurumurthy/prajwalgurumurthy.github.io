...
- BUS standard architectures (PCI,PCIe,SATA,IDE) [Expansion Buses/ IO buses]
...
- Interrupts and IRQ lines from devices to I/O Advanced Programmable Interrupt Controller (I/O APIC).
